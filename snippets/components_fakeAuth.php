<div class="row" >
    <div class="col-md-10">
        ...
        <div class="block align-right">
            <a href="javascript:void(0);" class="copyToClipboard" data-target="logindata">Copy Code</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        
                <pre class="pre-scrollable"><code class="html">users:
                        1:
...
<br>
<div class="block align-right">
    <a href="javascript:void(0);" class="copyToClipboard" data-target="loginform">Copy Code</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
...
<div id="loginform" class="hide">&lt;form action='' method='post' id="loginform">
    &lt;div class="form-group">
    &lt;label for="login">Email&lt;/label>
    &lt;input id="login" name='login' class='form-control'
    type='text' placeholder='Email' autofocus>
...
<div class="col-md-10">
    ...
    <div class="micropadding"></div>
    <div class="block align-right">
        <a href="javascript:void(0);" class="copyToClipboard" data-target="logout">Copy Code</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <pre><code>&lt;!-- Default Log out link -->
                &lt;a href="?logout=true">Log out&lt;/a>
        &lt;!-- Log out link without redirect -->
    &lt;a href="?logout=true&noredirect=true">Log out&lt;/a></code></pre>
    <div id="logout" class="hide">&lt;!-- Default Log out link -->
        &lt;a href="?logout=true">Log out&lt;/a>
        &lt;!-- Log out link without redirect -->
    &lt;a href="?logout=true&noredirect=true">Log out&lt;/a></div>
</div>
</div>