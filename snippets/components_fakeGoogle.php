<div class="row">
    <div class="col-md-10">
        ...
        <?php alert("<b>Heads up!</b><br>Google restricts the free searches over their Custom Search API to 100 searches per day. Therefore the search result page above displays alwas the same static result page.", "info", "inherit" , "boxid" , "" ); ?>
        <br>
