...
// forceLogin(); ?>
    ...
    <body class="">
            ...
            <div class="col-md-12 align-center">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <br><br>
                        <a href="https://github.com/liip/Protostrap"><i class="fa fa-github"></i> Protostrap on Github</a>
                    </div>
                </div>
            </div>
        </div>
        <!-- <div class="row">
            <div class="col-md-12 align-center">
                Read the documentation: <br><a href="basics.php">Basics</a> - <a href="advanced.php">Advanced</a> - <a href="data.php">Data</a>
            </div>
        </div>
        <br><br>
        <div class="row">
            <div class="col-md-12 align-center">
                <p class="sub"><span class="hide hidden-xs">The Complete </span>Feature List</p>
            </div>
        </div> -->
